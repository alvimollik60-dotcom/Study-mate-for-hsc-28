...
// লোডিং লজিকটিকে একটি ফাংশনে নিয়ে আসা হলো কাজের সুবিধার্থে
...
// --- ১ ও ২ নম্বর প্রোটেকশন: আপডেটেড কিক-আউট লজিক (ডাটাবেজ এবং লিডারবোর্ড থেকে তাৎক্ষণিক ডিলিট) ---
    ...
    if (confirm(`আপনি কি নিশ্চিতভাবে "${targetUsername}" ইউজারকে সম্পূর্ণ কিক করতে চান?`)) {
        try {
            if(window.fbFirestore && window.firebaseDb) {
                ...
                // ২. লাইভ অ্যাক্টিভিটি কালেকশন থেকেও ডিলিট (যাতে ড্যাশবোর্ড/লিডারবোর্ড থেকে সাথে সাথে চলে যায়)
...
// --- ১০. ফোন লক বা ব্যাকগ্রাউন্ড থেকে অন করার ইমার্জেন্সি রি-সিঙ্ক ব্যাকআপ লেয়ার (Visibility API) ---
document.addEventListener('visibilitychange', () => {
    if (document.visibilityState === 'visible') {
        // অ্যাপ ব্যাকগ্রাউন্ডে থাকলে বা লক অবস্থা থেকে ফিরে আসলে ডেড টাইম চেক করবে
        recoverDeadTime();
