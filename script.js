...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedUser) {
        ...
        loadUserData().then(() => {
            // অ্যাপ কটে দেওয়ার পর পুনরায় ওপেন করলে ডেড টাইম রিকভারি করা হবে
            recoverDeadTime();
...
async function saveThemeSettings() {
    ...
    try {
        if (window.fbFirestore && window.firebaseDb) {
            // Firebase Cloud Firestore-e save kora hocche
            ...
            // Fallback jodi firebase connect na thake
...
function initFirebaseGlobalListeners() {
    ...
    // --- ১. Real-time Theme Listener (Shobai eksathe change pabe) ---
    window.fbFirestore.onSnapshot(window.fbFirestore.doc(window.firebaseDb, "settings", "global_theme"), (docSnap) => {
        if (docSnap.exists()) {
            ...
            // Local storage-o update rakhbo backup er jonno
            ...
            // Instant document CSS properties change kora
            ...
            // Admin panel er color picker field gulo dynamic kora
...
function handleTimerTick() {
    ...
    // ২ ঘণ্টা অতিক্রম করলে অটোমেটিক টাইমার বন্ধ করার লজিক
    if (mainTimerSessionSeconds >= 7200) { 
        stopTimer();
...
// Checkbox ticks save manually in local
...
// --- १०. ফোন লক বা ব্যাকগ্রাউন্ড থেকে অন করার ইমার্জেন্সি রি-সিঙ্ক ব্যাকআপ লেয়ার (Visibility API) ---
